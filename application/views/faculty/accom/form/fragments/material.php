...
if ($session->get('accom_mat'))
{
	...
	foreach ($accom_mat as $mat)
	{
		...
		echo '<a class="btn btn-default" id="updateMaterial" material-id="', $mat['material_ID'], '" accom-id="', $session->get('accom_details')['accom_ID'], '" data-toggle="modal" data-target="#modal_material" role="button" href="" action-url="', URL::site('faculty/accom/edit/mat/'.$mat['material_ID']), '" ajax-url="', URL::site('extras/ajax/accom_details/mat'), '">
