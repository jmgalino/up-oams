  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="materialModalLabel">Authorship of Audio-Visual Materials/Learning Objects/Laboratory or Lecture Manuals</h4>
      </div>

      <?php print Form::open('', array('class'=>'form-horizontal', 'id'=>'materialForm', 'enctype'=>'multipart/form-data', 'role'=>'form')); ?>
      <div class="modal-body">
        <div class="alert alert-danger" style="display:none">
          <p class="text-center" id="material-alert"></p>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8" id="attachmentWrapper1">
            <input type="file" id="material-attachment" name="attachment[]" accept="image/*" multiple="true">
            <span class="help-block">You can add up to 5 attachments.</span>
          </div>
          <div class="col-sm-8" id="attachmentWrapper2"></div>
        </div>
      </div>
