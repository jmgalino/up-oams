...
<div class="modal fade" id="modal_other" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php print Form::open('faculty/accom/add/oth', array('class'=>'form-horizontal', 'id'=>'otherForm', 'enctype'=>'multipart/form-data', 'role'=>'form', 'ajax-url'=>URL::site('extras/ajax/check_date'))); ?>
