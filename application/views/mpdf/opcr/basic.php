...
<table class="table table-bordered padded">
  <tbody>
    ...
    <tr>
      ...
      <?php echo 
      '<td width="20" style="font-size:10px">', ($final_quantity ? adjectival_rating($final_quantity) : ''), '</td>
      <td width="20" style="font-size:10px">', ($final_efficiency ? adjectival_rating($final_efficiency) : ''), '</td>
      <td width="20" style="font-size:10px">', ($final_timeliness ? adjectival_rating($final_timeliness) : ''), '</td>
      <td width="20" style="font-size:10px">', ($final_average ? adjectival_rating($final_average) : ''), '</td>';
      ?>
      <td width="55"></td>
    </tr>
  </tbody>
