<?php
$opcr_ID = $this->site->session->get('ipcr_ID');
$opcr = $this->opcr->get_opcr($opcr_ID);
$user = $this->user->get_details($opcr[0]->user_ID);
$dept = $this->univ->get_department($user[0]->program_ID);
$college = $this->univ->get_college($user[0]->program_ID);
$name = $user[0]->first_name.' '.$user[0]->middle_initial.'. '.$user[0]->last_name;
...
echo View::factory('mpdf/opcr/fragment')->render();
echo View::factory('mpdf/opcr/legend')->render();
?>