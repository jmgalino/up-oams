	...
	<div class="container">
		...
		<div class="navbar-collapse collapse" id="navbar-collapse">
			<ul class="nav navbar-nav">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="<?php echo URL::site('faculty/coll/accom'); ?>">View College</a></li>
					</ul>
				</li>
				<li class="dropdown">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="<?php echo URL::site('faculty/coll/profiles'); ?>"><span class="glyphicon glyphicon-user"></span></a></li>
				<li><a href="<?php echo URL::site('faculty/coll/announcements'); ?>"><span class="glyphicon glyphicon-bullhorn"></span></a></li>
